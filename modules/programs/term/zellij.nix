  ...
  flake.modules.homeManager.base =
...

    {
      programs.zellij = {
        ...
        package =
          inputs.zellij.packages.${pkgs.stdenv.hostPlatform.system}.zellij-upstream.overrideAttrs
            (old: {
        ...
        # These follow home.shell.enableShellIntegration, which is on, and the
        # integration auto-starts a session from every interactive shell.
